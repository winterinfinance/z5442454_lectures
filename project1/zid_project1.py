...
#   description. See the assessment description file for more information.
# ----------------------------------------------------------------------------
#def read_dat(tic): #对于每个tic参数，打开相应的txt文件
...
#ta = {}
 #  with open(TICPATH) as file:
    #my_lines = [line.split('=').lower() for line in file]
   # print(my_lines)
    #ta[line[1].strip('"')] = line[0].strip('"')
#print(ta)
